...
abstract class AbstractEntityConverter<T> implements Converter<T> {
    ...
    private BiFunction<BandService, Integer, T> retrieveFunction;

    private Function<T, Integer> idExtractor;

    AbstractEntityConverter(Function<T, Integer> idExtractor, BiFunction<BandService, Integer, T> retrieveFunction) {
    ...
    public T getAsObject(FacesContext context, UIComponent component, String value) {
        T entity = retrieveFunction.apply(bandService, Integer.parseInt(value));
