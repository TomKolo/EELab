...
public abstract class AbstractEntityConverter<V> implements ParamConverterProvider {
    ...
    private BiFunction<BandService, Integer, V> retrieveFunction;

    private Function<V, Integer> idExtractor;

    AbstractEntityConverter(Class<V> entityClass, Function<V, Integer> idExtractor, BiFunction<BandService, Integer, V> retrieveFunction) {
    ...
    public <T> ParamConverter<T> getConverter(Class<T> rawType, Type genericType, Annotation[] annotations) {
        ...
        return (ParamConverter<T>) new ParamConverter<V>() {
            ...
            public V fromString(String value) {
                V entity = retrieveFunction.apply(bandService, Integer.valueOf(value));
